...
public final class Settings implements SettingHolder {
    ...
    public static final RoseSetting<ConfigurationSection> WORLDGUARD_SETTINGS = create("worldguard-settings", "Settings for WorldGuard", "If WorldGuard is not installed, these settings will do nothing");
    public static final RoseSetting<Boolean> WORLDGUARD_USE_ALLOWED_REGIONS = create("worldguard-settings.use-allowed-regions", BOOLEAN, false, "If true, particles will only be able to spawn if they are in an allowed region and not a disallowed region", "If false, particles will be able to spawn as long as they are not in a disallowed region");
    public static final RoseSetting<List<String>> WORLDGUARD_ALLOWED_REGIONS = create("worldguard-settings.allowed-regions", STRING_LIST, Arrays.asList("example_region_1", "example_region_2"), "Regions that particles will be allowed to spawn in", "WARNING: This setting is deprecated in favor of region flags, and will be removed in a future update.");
    public static final RoseSetting<List<String>> WORLDGUARD_DISALLOWED_REGIONS = create("worldguard-settings.disallowed-regions", STRING_LIST, Arrays.asList("example_region_3", "example_region_4"), "Regions that particles will be blocked from spawning in", "This overrides allowed regions if they overlap", "WARNING: This setting is deprecated in favor of region flags, and will be removed in a future update.");
