...
public class ParticleStylePopper extends DefaultParticleStyle {
    ...
    protected void loadSettings(CommentedFileConfiguration config) {
        ...
        this.popSpread = config.getFloat("pop-particle-spread");
        this.popSpeed = config.getFloat("pop-particle-speed");
        this.popOffset = config.getFloat("pop-particle-offset");
    }
